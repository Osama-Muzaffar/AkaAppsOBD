...
//			oStr.writeObject(DashboardActivity.Constants.mPluginPvs);
//
//			oStr.close();
//			fStr.close();
//
...
//				loadData(uri);
//				progress.dismiss();
//				reportTo.sendMessage(reportTo.obtainMessage(DashboardActivity.Constants.MESSAGE_FILE_READ));
//				Looper.loop();
//			}
//		};
//		loadTask.start();
...
//			DashboardActivity.Constants.mPluginPvs = (PvList) oIn.readObject();
//
//			oIn.close();
//
