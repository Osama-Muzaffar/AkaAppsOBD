...
//
//import com.mumbo.ecu.EcuDataPv;
//import com.mumbo.obdiiscannerassistant.Activity.DashboardActivity;
//import com.mumbo.ecu.prot.obd.ObdProt;
//
...
//		setTheme(DashboardActivity.Constants.nightMode ? R.style.AppTheme_Dark : R.style.AppTheme);
//		getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
//		                     WindowManager.LayoutParams.FLAG_FULLSCREEN);
//
//		// keep main display on?
//		if(DashboardActivity.Constants.prefs.getBoolean("keep_screen_on", false))
//		{
...
//		DashboardActivity.Companion.setFixedPids(pidNumbers);
//		// if auto hiding selected ...
//		if(DashboardActivity.Constants.prefs.getBoolean(DashboardActivity.Constants.PREF_AUTOHIDE,false))
//		{
//			// get autohide timeout [s]
//			int timeout = Integer.parseInt(
//				DashboardActivity.Constants.prefs.getString(DashboardActivity.Constants.PREF_AUTOHIDE_DELAY,"15") );
//			// auto hide toolbar
...
//			switch (msg.what)
//			{
//				case DashboardActivity.Constants.MESSAGE_UPDATE_VIEW:
//					/* update chart */
//					chartView.invalidate();
//					break;
//
//				// set toolbar visibility
//				case DashboardActivity.Constants.MESSAGE_TOOLBAR_VISIBLE:
...
//			Message msg = mHandler.obtainMessage(DashboardActivity.Constants.MESSAGE_UPDATE_VIEW);
