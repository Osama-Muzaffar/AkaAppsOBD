...
class ProcessVarBeanInfo extends SimpleBeanInfo
{
	...
	private static EventSetDescriptor[] getEdescriptor()
	{
		...
		try
		{
			eventSets[EVENT_pvChangeListener] = new EventSetDescriptor(ProcessVar.class, "pvChangeListener", PvChangeListener.class, new String[]{"pvChanged"}, "addPvChangeListener", "removePvChangeListener");
		} catch (IntrospectionException ignored)
		{
	...
	private static MethodDescriptor[] getMdescriptor()
	{
		...
		try
		{
			methods[METHOD_addPvChangeListener0] = new MethodDescriptor(ProcessVar.class.getMethod("addPvChangeListener",
				PvChangeListener.class, Integer.TYPE));
			methods[METHOD_addPvChangeListener0].setDisplayName("");
			methods[METHOD_clear1] = new MethodDescriptor(ProcessVar.class.getMethod("clear"));
			methods[METHOD_clear1].setDisplayName("");
			methods[METHOD_clone2] = new MethodDescriptor(ProcessVar.class.getMethod("clone"));
			methods[METHOD_clone2].setDisplayName("");
			methods[METHOD_containsKey3] = new MethodDescriptor(ProcessVar.class.getMethod("containsKey",
				Object.class));
			methods[METHOD_containsKey3].setDisplayName("");
			methods[METHOD_containsValue4] = new MethodDescriptor(ProcessVar.class.getMethod("containsValue",
				Object.class));
			methods[METHOD_containsValue4].setDisplayName("");
			methods[METHOD_entrySet5] = new MethodDescriptor(ProcessVar.class.getMethod("entrySet"));
			methods[METHOD_entrySet5].setDisplayName("");
			methods[METHOD_equals6] = new MethodDescriptor(ProcessVar.class.getMethod("equals",
				Object.class));
			methods[METHOD_equals6].setDisplayName("");
			methods[METHOD_get7] = new MethodDescriptor(ProcessVar.class.getMethod("get",
				Object.class));
			methods[METHOD_get7].setDisplayName("");
			methods[METHOD_hashCode8] = new MethodDescriptor(ProcessVar.class.getMethod("hashCode"));
			methods[METHOD_hashCode8].setDisplayName("");
			methods[METHOD_keySet9] = new MethodDescriptor(ProcessVar.class.getMethod("keySet"));
			methods[METHOD_keySet9].setDisplayName("");
			methods[METHOD_put10] = new MethodDescriptor(ProcessVar.class.getMethod("put",
				Object.class, Object.class, Integer.TYPE));
			methods[METHOD_put10].setDisplayName("");
			methods[METHOD_putAll11] = new MethodDescriptor(ProcessVar.class.getMethod("putAll",
				java.util.Map.class, Integer.TYPE, Boolean.TYPE));
			methods[METHOD_putAll11].setDisplayName("");
			methods[METHOD_pvChanged12] = new MethodDescriptor(ProcessVar.class.getMethod("pvChanged",
				PvChangeEvent.class));
			methods[METHOD_pvChanged12].setDisplayName("");
			methods[METHOD_remove13] = new MethodDescriptor(ProcessVar.class.getMethod("remove",
				Object.class));
			methods[METHOD_remove13].setDisplayName("");
			methods[METHOD_size14] = new MethodDescriptor(ProcessVar.class.getMethod("size"));
			methods[METHOD_size14].setDisplayName("");
			methods[METHOD_toString15] = new MethodDescriptor(ProcessVar.class.getMethod("toString"));
			methods[METHOD_toString15].setDisplayName("");
			methods[METHOD_values16] = new MethodDescriptor(ProcessVar.class.getMethod("values"));
